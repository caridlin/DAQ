...
Friend Class frmShowFileData
    ...
    Const ArraySize As Integer = 10     ' size of data array
    Dim Rate As Integer = 1000          ' per channel rate

    Dim DataBuffer() As UInt16  ' declare data array
    Dim FileName As String      ' name of file in which data will be stored

    Private Sub frmShowFileData_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            lblAcqStat.Text = "Click Start to read analog inputs on board " & _
            DaqBoard.BoardNum.ToString() & " and write data to file."
    ...
    ByVal eventArgs As System.EventArgs) Handles cmdStartAcq.Click
        ...
        ' Parameters:
        Count = NumPoints
        FileName = txtFileName.Text ' it may be necessary to add path
        LowChan = 0
        HighChan = 0
        Options = MccDaq.ScanOptions.Default

        DataCount = NumPoints.ToString("0")
        lblAcqStat.Text = "Collecting " & DataCount & _
        " data points from board " & DaqBoard.BoardNum.ToString() & "."
        ...
        ULStat = DaqBoard.FileAInScan(LowChan, HighChan, Count, _
            Rate, Range, FileName, Options)
    ...
    Private Sub cmdShowData_Click(ByVal eventSender As System.Object, _
    ByVal eventArgs As System.EventArgs) Handles cmdShowData.Click
        ...
        ULStat = MccDaq.MccService.FileRead(FileName, FirstPoint, ReadPoints, DataBuffer)
        If ULStat.Value <> MccDaq.ErrorInfo.ErrorCode.NoErrors Then Stop
        lblAcqStat.Text = ""
        lblAcqStat.Text = "Click Start to read analog inputs on board " & _
        DaqBoard.BoardNum.ToString() & " and write data to file."
...
#Region "Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.lblAcqStat.Location = New System.Drawing.Point(9, 27)
        Me.lblAcqStat.Name = "lblAcqStat"
        Me.lblAcqStat.RightToLeft = System.Windows.Forms.RightToLeft.No
        Me.lblAcqStat.Size = New System.Drawing.Size(332, 29)
        ...
        Me.lblDemoFunction.Size = New System.Drawing.Size(335, 18)
...
#Region "Universal Library Initialization - Expand this region to change error handling, etc."
    ...
    Private Sub InitUL()
        ...
        Me.lblShowData = New System.Windows.Forms.Label(9) _
