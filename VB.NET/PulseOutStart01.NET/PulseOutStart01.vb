...
Public Class frmPulseOutput
    ...
    Const CounterType As Integer = CTRPULSE    ' type of counter compatible with this sample
    Private CounterNum, NumCtrs As Integer

    Private DaqBoard As MccDaq.MccBoard = New MccDaq.MccBoard(0)

    Private Sub frmPulseOutput_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        InitUL()
        NumCtrs = FindCountersOfType(DaqBoard, CounterType, CounterNum)
        If NumCtrs < 1 Then
            Me.lblUseScroll.Text = "Board " & DaqBoard.BoardNum.ToString() & _
                " has no pulse generators."
            Me.UpdateButton.Enabled = False
            Me.txtDutyCycleToSet.Enabled = False
            Me.txtFrequencyToSet.Enabled = False
        Else
            Me.lblDemoFunction.Text = "Demonstration of " & _
            "MccDaq.MccBoard.PulseOutStart() and " & _
            "MccDaq.MccBoard.PulseOutStop() using board " & _
    ...
    Private Sub UpdateButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles UpdateButton.Click
        ...
        Catch ex As Exception
            MessageBox.Show(txtFrequencyToSet.Text & _
            " is not a valid frequency value", "Invalid Frequency ", _
        ...
        Catch ex As Exception
            MessageBox.Show(txtDutyCycleToSet.Text & _
            " is not a valid duty cycle value", "Invalid Duty Cycle ", _
            MessageBoxButtons.OK, MessageBoxIcon.Error)
            IsValidNumber = False
        End Try
        ...
        If (IsValidNumber) Then
            ...
            ULStat = DaqBoard.PulseOutStart(CounterNum, Frequency, _
            DutyCycle, PulseCount, InitialDelay, IdleState, Options)
            If ULStat.Value <> MccDaq.ErrorInfo.ErrorCode.NoErrors Then Stop

            lblValueSent.Text = "The frequency sent to timer " & _
            Format(CounterNum, "0") & " was:"
            lblFrequency.Text = "The frequency output from timer channel " & _
            Format(CounterNum, "0") & " is:"
            ...
            lblDutyCycle.Text = "The duty cycle output from timer channel " & _
            Format(CounterNum, "0") & " is:"
    ...
    Private Sub cmdEndProgram_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEndProgram.Click
        ...
        If NumCtrs > 0 Then DaqBoard.PulseOutStop(0)
        Me.Close()
...
#Region "Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.txtFrequencyToSet.Location = New System.Drawing.Point(104, 135)
        ...
        Me.txtFrequencyToSet.Size = New System.Drawing.Size(81, 20)
        ...
        Me.lblFrequency.Location = New System.Drawing.Point(5, 224)
        ...
        Me.lblValueSent.Location = New System.Drawing.Point(5, 208)
        ...
        Me.lblValueSent.TextAlign = System.Drawing.ContentAlignment.TopRight
        '
        'lblUseScroll
        '
        ...
        Me.lblUseScroll.ForeColor = System.Drawing.Color.Red
        Me.lblUseScroll.Location = New System.Drawing.Point(35, 69)
        Me.lblUseScroll.Name = "lblUseScroll"
        Me.lblUseScroll.RightToLeft = System.Windows.Forms.RightToLeft.No
        Me.lblUseScroll.Size = New System.Drawing.Size(269, 53)
        ...
        Me.lblUseScroll.Text = "Enter a frequency and a duty cycle within the timer's range and click Update Butt" & _
            "on when done."
        Me.lblUseScroll.TextAlign = System.Drawing.ContentAlignment.TopCenter
        '
        'lblDemoFunction
        '
        ...
        Me.lblDemoFunction.Location = New System.Drawing.Point(67, 10)
        Me.lblDemoFunction.Name = "lblDemoFunction"
        Me.lblDemoFunction.RightToLeft = System.Windows.Forms.RightToLeft.No
        Me.lblDemoFunction.Size = New System.Drawing.Size(198, 59)
        ...
        Me.UpdateButton.Location = New System.Drawing.Point(200, 151)
        ...
        'lblFreq
        '
        Me.lblFreq.Location = New System.Drawing.Point(32, 135)
        ...
        'lblDC
        '
        Me.lblDC.Location = New System.Drawing.Point(32, 167)
        Me.lblDC.Name = "lblDC"
        ...
        Me.txtDutyCycleToSet.Location = New System.Drawing.Point(104, 167)
        ...
        Me.txtDutyCycleToSet.Size = New System.Drawing.Size(81, 20)
        ...
        Me.lblDutyCycle.Location = New System.Drawing.Point(5, 272)
        ...
        Me.lblDutyCycle.TextAlign = System.Drawing.ContentAlignment.TopRight
        '
        'lblDCShowValue
        '
        ...
        Me.lblDCValueSent.Location = New System.Drawing.Point(5, 256)
        ...
        Me.lblDCValueSent.TextAlign = System.Drawing.ContentAlignment.TopRight
        '
        'frmPulseOutput
        '
        ...
        Me.Controls.Add(Me.lblShowDutyCycle)
        Me.Controls.Add(Me.lblDutyCycle)
        Me.Controls.Add(Me.lblDCShowValue)
        Me.Controls.Add(Me.lblDCValueSent)
        Me.Controls.Add(Me.txtDutyCycleToSet)
