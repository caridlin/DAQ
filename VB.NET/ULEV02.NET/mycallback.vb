...
Module EventHandler
    ...
    '
    Public Sub MyCallback(ByVal bd As Integer, ByVal EventType As MccDaq.EventType, _
        ByVal EventData As UInt32, ByVal userData As System.IntPtr)
    ...
    Public Sub OnErrorCallback(ByVal bd As Integer, ByVal EventType As MccDaq.EventType, _
        ByVal EventData As UInt32, ByVal userData As System.IntPtr)
