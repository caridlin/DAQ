...
Friend Class frmStatusDisplay
    ...
    Private Sub frmStatusDisplay_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        ...
        Dim NumCntrs, NumPorts, CounterNum As Integer
        Dim ProgAbility, NumBits, FirstBit As Integer
        ...
        Dim ChannelType As Integer = CTRSCAN

        ' determine the number of analog, digital, and counter channels and their capabilities
        NumCntrs = FindCountersOfType(DaqBoard, ChannelType, CounterNum)
        ChannelType = PORTIN
        If Not GeneralError Then _
            NumPorts = FindPortsOfType(DaqBoard, ChannelType, _
        ...
        Else
            ...
            If NumBits = 16 Then ChanTypeArray(1) = MccDaq.ChannelType.Digital16
            ...
            If ProgAbility Then
                'configure programmable for digital input
                PortNum = ChanArray(1)
                ...
                End If
            End If
            ULStat = DaqBoard.CConfigScan(0, MccDaq.CounterMode.Bit16, _
            MccDaq.CounterDebounceTime.DebounceNone, MccDaq.CounterDebounceMode.TriggerAfterStable, _
            MccDaq.CounterEdgeDetection.FallingEdge, MccDaq.CounterTickSize.Tick20833pt3ns, 0)
            lblInstruction.Text = "Board " & DaqBoard.BoardNum.ToString() & _
                " collecting analog, digital, and counter data " & _
    ...
    Private Sub cmdStartBgnd_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdStartBgnd.Click
        ...
        Dim CurIndex, CurCount, Rate As Integer
        Dim Count, PretrigCount As Integer
        Dim Status As Short
        Dim ULStat As MccDaq.ErrorInfo
...
#Region "Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.cmdQuit.Location = New System.Drawing.Point(286, 284)
        ...
        Me.cmdStopConvert.Location = New System.Drawing.Point(89, 116)
        ...
        Me.cmdStartBgnd.Location = New System.Drawing.Point(89, 116)
        ...
        Me.lblShowCount.Location = New System.Drawing.Point(205, 299)
        ...
        Me.lblCount.Location = New System.Drawing.Point(90, 299)
        ...
        Me.lblShowIndex.Location = New System.Drawing.Point(205, 280)
        ...
        Me.lblIndex.Location = New System.Drawing.Point(90, 280)
        ...
        Me.lblShowStat.Location = New System.Drawing.Point(230, 260)
        ...
        Me.lblStatus.Location = New System.Drawing.Point(12, 260)
        ...
        Me._lblADData_2.Location = New System.Drawing.Point(142, 223)
        ...
        Me.lblChan2.Location = New System.Drawing.Point(46, 223)
        ...
        Me._lblADData_1.Location = New System.Drawing.Point(142, 196)
        ...
        Me.lblChan1.Location = New System.Drawing.Point(30, 196)
        ...
        Me._lblADData_0.Location = New System.Drawing.Point(142, 169)
        ...
        Me.lblChan0.Location = New System.Drawing.Point(46, 169)
        ...
        Me.lblInstruction.Location = New System.Drawing.Point(46, 47)
        ...
        Me.lblInstruction.TabIndex = 22
        Me.lblInstruction.Text = "Board 0 must have analog, digital, and counter inputs that support paced acquisit" & _
            "ion."
        ...
        Me.ClientSize = New System.Drawing.Size(350, 338)
...
#Region "Universal Library Initialization - Expand this region to change error handling, etc."
    ...
    Private Sub InitUL()
        ...
        {Me._lblADData_0, Me._lblADData_1, Me._lblADData_2})
