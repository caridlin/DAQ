...
Public Class frmCountTest
    ...
    Const CounterType As Integer = CTR8254    ' type of counter compatible with this sample
    Private CounterNum, NumCtrs As Integer

    'Create a new MccBoard object for Board 0
    Private DaqBoard As MccDaq.MccBoard = New MccDaq.MccBoard(0)

    Dim RegName As MccDaq.CounterRegister  ' register name of counter

    Private Sub frmCountTest_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            lblNoteFreqIn.Text = "NOTE: There must be a TTL frequency at the counter " & _
